...
#   value = element(split(",", lookup(var.standard_os, var.vm_os_simple, "")), 0) == "MicrosoftWindowsServer" || lookup(var.standard_os, var.vm_os_simple, "")), 0) == "MicrosoftWindowsDesktop")) ? 3389 : 22
# }
